...
const CreateArticlePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await toast.promise(
      axios.post(`${import.meta.env.VITE_API_URL}/api/blog/create`, formData, {
  ...
  return (
    <div>
      <h1 className="font-bold text-white text-2xl">Create New Article</h1>
      ...
      <form onSubmit={handleSubmit} className="bg-[#052B2D] mt-5 h rounded-md p-5">
        ...
        <div className="mt-5 flex gap-2 flex-wrap">
          ...
          <Link to={loading ? "" : "/dashboard/articles"}>
