...
import { BookHeart, Pencil, Search, Trash } from "lucide-react";
...
const ServicesDashboardPage = () => {
  ...
  const handleDelete = async (id) => {
    await toast.promise(
      axios.delete(`${import.meta.env.VITE_API_URL}/api/service/delete/${id}`, {
  ...
  return (
    <div>
      <h1 className="font-bold text-white text-2xl">Services</h1>
        ...
        <div className="md:flex justify-between items-center">
          <div className="flex items-center  bg-[#052B2D]  shadow  rounded-md px-2 w-full md:w-1/3  ">
            ...
            <Input
              ...
              value={searchTerm}
              placeholder="Search for service by name..."
      ...
      <div className="bg-[#052B2D] mt-5 rounded-md p-5">
        <Table>
          <TableCaption>Table of services</TableCaption>
          <TableHeader>
            <TableRow>
                  ...
                  <TableRow key={index} className={"text-zinc-300"}>
                    ...
                    <TableCell>
                      <div className="flex items-center  gap-3">
                        <Link to={`/dashboard/edit-service/${item._id}`} className="flex gap-1 underline text-blue-400 cursor-pointer items-center">
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>Once deleted, this service cannot be recovered.</AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
